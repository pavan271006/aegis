/* ═══════════════════════════════════════════════════════════════════════
   AEGIS — Icon system
   Lightweight inline stroke icons (no dependency). 24×24 grid, currentColor,
   1.75 stroke. Use <Icon name="shield" /> instead of emoji anywhere in the UI.
   ═══════════════════════════════════════════════════════════════════════ */
...
const PATHS = {
  ...
  bug: (
    <>
      ...
      <path d="M8 11H4M20 11h-4M8 16H4M20 16h-4M9 6l-1.5-2M15 6l1.5-2" />
    </>
  ),
  database: (
    <>
  ...
  bell: (
    <>
      <path d="M18 9a6 6 0 1 0-12 0c0 7-3 9-3 9h18s-3-2-3-9z" />
  ...
  key: (
    <>
      ...
      <path d="M10.8 12.2L21 2M16 7l3 3M14 9l2 2" />
    </>
  ),
  cloud: <path d="M7 18a4 4 0 0 1 0-8 6 6 0 0 1 11.5 1.5A3.5 3.5 0 0 1 18 18H7z" />,
  ...
  map: (
    <>
      <path d="M21 5l-6-2-6 2-6-2v16l6 2 6-2 6 2V5z" />
